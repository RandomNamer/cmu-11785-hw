...
class CNN_SimpleScanningMLP():
    def __init__(self):
        ...
        # ...
        # <---------------------
        self.conv1 = Conv1d(in_channels=24, out_channels=8, kernel_size=8, stride=4, weight_init_fn=None, bias_init_fn=None)
        self.conv2 = Conv1d(in_channels=8, out_channels=16, kernel_size=1, stride=1, weight_init_fn=None, bias_init_fn=None)
        self.conv3 = Conv1d(in_channels=16, out_channels=4, kernel_size=1, stride=1, weight_init_fn=None, bias_init_fn=None)
        self.layers = [self.conv1, ReLU(),  self.conv2, ReLU(), self.conv3, ReLU()]
