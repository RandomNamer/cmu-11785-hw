...
class ConvTranspose1d():
    ...
    def backward(self, dLdZ):
        ...
        # target_delta_size = self.conv1d_stride1.input_size
        # pad_size = target_delta_size - output_size
        # dLdZ_padded = np.pad(dLdZ, ((0, 0), (0, 0), (0, pad_size)), 'constant')
        
        # print(target_delta_size, output_size, pad_size, dLdZ_padded.shape, delta_out.shape)
